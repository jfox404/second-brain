# 02 — Review skill (capture enrichment)

**What to build:** A skill file at `.agents/skills/review/SKILL.md` that the user invokes via Copilot agent mode to process unprocessed captures in today's daily note.
...
- [ ] Skill file exists at `.agents/skills/review/SKILL.md`
