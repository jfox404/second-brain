# 05 — Wire reflect into remaining vault skills

**What to build:** Update all vault-specific skills (archive-project, promote-project, create-project, inbox-review) to invoke the reflect skill as their final step, matching the pattern established in the daily review skill.
